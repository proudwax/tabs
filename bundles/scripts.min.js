...
modules.define('tabs', function (provide) {
    ...
    function inited(className) {
        ...
        tabs = parent.querySelector('.' + _modulName) || parent.parentNode.querySelector('.' + _modulName + className), tabsNavItems = tabs.querySelectorAll('.' + _modulName + '__nav-item'), tabsContents = tabs.querySelectorAll('.' + _modulName + '__content');
